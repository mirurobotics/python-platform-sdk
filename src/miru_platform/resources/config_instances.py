...
from ..types import (
    ...
    config_instance_download_content_params,
)
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    config_instance_download_content_params.ConfigInstanceDownloadContentParams,
                ),
            ),
...
class ConfigInstancesResourceWithRawResponse:
    def __init__(self, config_instances: ConfigInstancesResource) -> None:
        ...
        self.download_content = to_custom_raw_response_wrapper(
            config_instances.download_content,
            BinaryAPIResponse,
        )
...
class AsyncConfigInstancesResourceWithRawResponse:
    def __init__(self, config_instances: AsyncConfigInstancesResource) -> None:
        ...
        self.download_content = async_to_custom_raw_response_wrapper(
            config_instances.download_content,
            AsyncBinaryAPIResponse,
        )
