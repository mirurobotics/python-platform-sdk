...
from miru_platform_sdk import Miru, AsyncMiru, APIResponseValidationError
from miru_platform_sdk._types import Omit
from miru_platform_sdk._utils import asyncify
from miru_platform_sdk._models import BaseModel, FinalRequestOptions
from miru_platform_sdk._exceptions import MiruError, APIStatusError, APITimeoutError, APIResponseValidationError
from miru_platform_sdk._base_client import (
    DEFAULT_TIMEOUT,
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "miru_platform_sdk/_legacy_response.py",
                        "miru_platform_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "miru_platform_sdk/_compat.py",
