...
pip install git+ssh://git@github.com/stainless-sdks/miru-platform-python.git
```
...
```sh
# install from this staging repo
pip install 'miru_platform[aiohttp] @ git+ssh://git@github.com/stainless-sdks/miru-platform-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/miru-platform-python/tree/main/src/miru_platform/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/miru-platform-python/tree/main/src/miru_platform/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/miru-platform-python/issues) with questions, bugs, or suggestions.
