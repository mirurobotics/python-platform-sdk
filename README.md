...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/miru_platform_sdk.svg?label=pypi%20(stable))](https://pypi.org/project/miru_platform_sdk/)
...
```sh
# install from PyPI
pip install miru_platform_sdk[aiohttp]
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/mirurobotics/python-platform-sdk/issues) with questions, bugs, or suggestions.
